# This is a ToDo App created with create-react-app. Below is the create-react app readme. A lot of it is not necessary for this project now, but could be useful in the future, so I have left it for reference. The only update made to the readme was the folder structure. 
